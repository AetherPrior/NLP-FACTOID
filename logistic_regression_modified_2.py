...
X_Q_tr,X_Q_te,y_Q_tr,y_Q_te =train_test_split(train.iloc[:,1], y, test_size=0.2)
X_A_tr,X_A_te,y_A_tr,y_A_te =train_test_split(train.iloc[:,2], y, test_size=0.2)
